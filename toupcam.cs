...
internal class Toupcam : IDisposable
{
    ...
    {
        OPTION_NOFRAME_TIMEOUT        = 0x01,       /* no frame timeout: 0 = disable, positive value = timeout milliseconds. default: disable */
    ...
    /* get the version of this dll/so, which is: 53.20896.20220521 */
    ...
    */
    ...
    public bool get_AfParam(out AfParam pAfParam)
    {
        ...
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_AfParam(handle_, out pAfParam));
    }
    ...
    public bool GetHistogram(DelegateHistogramCallback funHistogram)
    {
        ...
        return CheckHResult(Toupcam_GetHistogram(handle_, pHistogram_, id_));
    }
    ...
    */
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete("Use Toupcam_EnumV2")]
    ...
    */
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Toupcam_GetHistogram(SafeCamHandle h, HISTOGRAM_CALLBACK funHistogram, IntPtr ctxHistogram);
